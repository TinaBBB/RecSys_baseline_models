...
class VAE(object):
    ...
    def __init__(self, observation_dim, latent_dim, batch_size,
                 ...
                 observation_std=0.01):               # default stdev for the observed data
...
def vae_cf(matrix_train, embeded_matrix=np.empty((0)),
           iteration=100, lam=80, rank=200, corruption=0.5, optimizer="RMSProp", seed=1, **uused):
